...
<head>
    ...
    <?php
        ...
        $listaColaboradores = $tfg->ListarColaboradores();
...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
            ...
            <form action="../../CapaNegocio/GestionColaboradores.php?id_tfg=<?php echo $id_tfg?>&tipo=ins" class="form-neon mt-1" autocomplete="off" method="post">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label class="text-primary mr-4">Tutor para el T.F.G. </label>
            ...
            <div class="container-fluid form-neon">
                <div class="table-responsive">
                    <table class="table table-dark table-sm">
                        ...
                        <tbody>
                            <?php
                                foreach ($listaColaboradores as $reg) {
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="../../CapaNegocio/GestionColaboradores.php?id_tfg=<?php echo $id_tfg?>&tipo=elim&id_colaborador=<?php echo $reg['id'] ?>" method="post">
