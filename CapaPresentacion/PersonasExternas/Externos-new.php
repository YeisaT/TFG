		...
		<main class="full-box main-container">
			...
			<section class="full-box page-content">
				...
				<div class="full-box page-header">
					<h3 class="text-left">
						<i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR PERSONA EXTERNA
					</h3>
					<p class="text-justify">
						Se registra los datos de la Persona Externa a la UTEPSA, lo que corresponde a Academico
					</p>
				</div>
				...
				<div class="container-fluid">
					<ul class="full-box list-unstyled page-nav-tabs">
						<li>
							<a class="active" href="Externos-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR EXTERNOS</a>
						</li>
						<li>
							<a href="Externos-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE EXTERNOS</a>
						</li>
						<li>
							<a href="#"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR EXTERNOS</a>
						</li>
					</ul>
				</div>
				...
				<!-- Content here-->
				<div class="container-fluid">
					<form action="../../CapaNegocio/Externo_guardar.php" class="form-neon" autocomplete="off" method="post">
						<fieldset>
							...
							<legend><i class="fas fa-user"></i> &nbsp; Información Adicional</legend>
							<div class="container-fluid">
								<div class="row">
									<div class="col-12 col-md-4">
										<div class="form-group">
											<label for="institucion" class="bmd-label-floating">Institución</label>
											<input type="text"  class="form-control" name="institucion" id="institucion" maxlength="100">
										</div>
									</div>
									<div class="col-12 col-md-4">
										<div class="form-group">
