	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTADO DE PERSONA EXTERNAS
				</h3>
				<p class="text-justify">
					Listado de Personas Externas a la UTEPSA y quienes pueden interactuar con los Trabajos Finales de Grado.
				</p>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="Externos-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR PERSONA EXTERNA</a>
					</li>
					<li>
						<a href="Externos-list.php" class="active"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PERSONAS EXTERNAS</a>
					</li>
					<li>
						<a href="#"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR EXTERNO</a>
					</li>
				</ul>	
			</div>
			...
			<?php 
               ...
               $data = $rep->ListadoPersonasExternas();
               //var_dump($data);
            ?>
						...
						<tbody>
                            ...
                            ?>
                                <tr>
									...
									<td> <?php echo $reg['institucion']?>   </td>
