	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; REGISTRAR REVISIÓN 
				</h3>
				<p class="text-justify">
					Seleccionar el trabajo Final de Grado para el cual se registrará la revisión.
				</p>
			</div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="Revision.php?id_tfg=<?php echo $reg['id']?>&err=" class="btn btn-success">
