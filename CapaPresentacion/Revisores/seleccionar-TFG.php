		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				...
				<p class="text-justify">
					Seleccionar el trabajo Final de Grado para el cual gestionará sus docentes que realizaran las revisiones.
				</p>
			</div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="Revisores.php?id_tfg=<?php echo $reg['id']?>&err=" class="btn btn-success">
